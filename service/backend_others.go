...
// BAD!!!
// These codes should be removed because we had had general `sysvInitD`
type initD struct {
	Logger ZLogger
}
...
func (s *initD) Choose(ctx context.Context) (ok bool) {
...
func (s *initD) IsValid(ctx context.Context) (valid bool) {
	if systems.HasLinuxBackends {
		valid = hasInitD(ctx)
	}
...
func hasInitD(ctx context.Context) bool {
...
func (s *initD) initSyslogger(ctx context.Context, config *Config, m *mgmtS, cmd Command) (err error) {
	if s.Logger != nil {
		return
	}
...
func (s *initD) Control(ctx context.Context, config *Config, m *mgmtS, cmd Command) (err error) {
	if fn, ok := initdCommands[cmd]; ok {
...
var initdCommands = map[Command]func(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error){
	Info:      initdInfo,
	Port:      initdPort,
	Addr:      initdAddr,
	Start:     initdStart,
	Stop:      initdStop,
	Status:    initdStatus,
	Restart:   initdRestart,
	HotReload: initdHotReload,
	Install:   initdInstall,
	Uninstall: initdUninstall,
	Enable:    initdEnable,
	Disable:   initdDisable,
	ViewLog:   initdViewLog,
}

func initdInfo(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdPort(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdAddr(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdStart(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdStop(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdStatus(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdRestart(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdHotReload(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdIsActive(config *Config) (text string, err error) {
	var retCode int
...
func initdIsRunning(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	var text string
	text, err = initdIsActive(config)
...
func initdIsInactive(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	var text string
	text, err = initdIsActive(config)
	if text != "inactive" {
...
func initdIsStarted(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	var text string
	text, err = initdIsActive(config)
	if text != "activating" {
...
func initdIsEnabled(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	var retCode int
	var text string
...
func initdGetStatus(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	return
}
...
func initdInstall(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
`
	...
	if autoEnable := config.AutoEnable; autoEnable {
		err = initdEnable(ctx, config, m, s)
	}
...
func initdUninstall(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	...
	if err = initdStop(ctx, config, m, s); err != nil {
		dbglog.WarnContext(ctx, "systemd stop command failed.", "err", err)
		// return
	}

	if err = initdDisable(ctx, config, m, s); err != nil {
...
func initdEnable(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
	if fn, ok := config.Entity.(EntityEnableAware); ok {
		return fn.Enable(ctx, config, s.Logger)
	}

	if initdIsEnabled(ctx, config, m, s) == nil {
...
func initdDisable(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
...
func initdViewLog(ctx context.Context, config *Config, m *mgmtS, s *initD) (err error) {
