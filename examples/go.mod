...
require (
	github.com/hedzr/cmdr-addons/service/v2 v2.2.3
	github.com/hedzr/cmdr-addons/v2 v2.2.9
	github.com/hedzr/cmdr-loaders v1.4.9
...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.4.9 // indirect
	github.com/hedzr/store/codecs/hjson v1.4.9 // indirect
	github.com/hedzr/store/codecs/json v1.4.9 // indirect
	github.com/hedzr/store/codecs/nestext v1.4.9 // indirect
	github.com/hedzr/store/codecs/toml v1.4.9 // indirect
	github.com/hedzr/store/codecs/yaml v1.4.9 // indirect
